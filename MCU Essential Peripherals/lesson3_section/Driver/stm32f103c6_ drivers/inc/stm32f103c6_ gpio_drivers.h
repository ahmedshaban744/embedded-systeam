...
#ifndef INC_STM32F103C6__GPIO_DRIVERS_H_
#define INC_STM32F103C6__GPIO_DRIVERS_H_
//---------------------------
//includes
//----------------------------
...
#define GPIO_MODE_INPUT_PU           0x00000002  //pull-up  mode
#define GPIO_MODE_INPUT_PD           0x00000003  //Open-drain mode

#define GPIO_MODE_OUTPUT_PP  	     0x00000004  //General purpose output Open-drain
#define GPIO_MODE_OUTPUT_OD 	     0x00000005  //General purpose output Open-drain
#define GPIO_MODE_OUTPUT_AF_PP  	 0x00000006  //Alternate function output Push-pull
#define GPIO_MODE_OUTPUT_AF_OD  	 0x00000007  //Alternate function output Open-drain
#define GPIO_MODE_INPUT_AF 			 0x00000008  //Alternate function input
//GPIO_SPEED_define
...
#endif /* INC_STM32F103C6__GPIO_DRIVERS_H_ */
