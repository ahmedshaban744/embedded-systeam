...
#define RS_SWITCH 1   //SELECT REGISTER ( 1 FOR DATA | 0 FOR COMMAND)
#define RW_SWITCH 2  //read _ write register ( 1for reed | 0 for write)
#define EN_SWITCH 3  // enable  to start
#define  shift 4
...
void display_int_number(int number);
void display_float_number(double number);
