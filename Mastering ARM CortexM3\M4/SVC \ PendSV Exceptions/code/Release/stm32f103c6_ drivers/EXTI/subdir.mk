...
stm32f103c6_\ drivers/EXTI/stm32f103c6_\ EXTI_drivers.o: ../stm32f103c6_\ drivers/EXTI/stm32f103c6_\ EXTI_drivers.c stm32f103c6_\ drivers/EXTI/subdir.mk
	arm-none-eabi-gcc "$<" -mcpu=cortex-m3 -std=gnu11 -DSTM32 -DSTM32F1 -DSTM32F103C6Tx -c -I../Inc -Os -ffunction-sections -fdata-sections -Wall -fstack-usage -MMD -MP -MF"stm32f103c6_ drivers/EXTI/stm32f103c6_ EXTI_drivers.d" -MT"$@" --specs=nano.specs -mfloat-abi=soft -mthumb -o "$@"
