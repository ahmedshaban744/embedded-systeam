...
stm32f103c6_\ drivers/Hall/EEPROM/EEPROM.o: ../stm32f103c6_\ drivers/Hall/EEPROM/EEPROM.c stm32f103c6_\ drivers/Hall/EEPROM/subdir.mk
	arm-none-eabi-gcc "$<" -mcpu=cortex-m3 -std=gnu11 -DSTM32 -DSTM32F1 -DSTM32F103C6Tx -c -I../Inc -Os -ffunction-sections -fdata-sections -Wall -fstack-usage -MMD -MP -MF"stm32f103c6_ drivers/Hall/EEPROM/EEPROM.d" -MT"$@" --specs=nano.specs -mfloat-abi=soft -mthumb -o "$@"
